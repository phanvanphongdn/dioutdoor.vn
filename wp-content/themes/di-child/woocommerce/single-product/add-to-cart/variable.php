								...
								if ( is_array( $options ) ) {
									...
									if ( taxonomy_exists( $attribute_name ) ) {
										...
										foreach ( $terms as $term ) {
                                            ...
                                            }elseif ( $swatches_use_variation_images && 'pa_mau' === $attribute_name && isset( $swatches[ $key ]['image_src'] ) ) {//vucamp
                                                $image = wp_get_attachment_image( get_post_thumbnail_id( $swatches[ $key ]['variation_id'] ), 'woocommerce_thumbnail' );
                                            ...
                                            elseif ( ! empty( $swatches[ $key ]['image'] ) && ( ! is_array( $swatches[ $key ]['image'] ) || ( is_array( $swatches[ $key ]['image'] ) && $swatches[ $key ]['image']['id'] ) ) ) {//vucamp
